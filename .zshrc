...
export HISTORY_IGNORE="(history|cd|hostname|cmake ..|make(| install)|vi(|m)|screen(|list|join)|ip a|df(| -h)|(bash|zsh)(| -l)|zl|py(py|thon)(|3)(| --version)|ls(| -(|a)(|l))|pwd|ps(| -(|a)ux)|top|exit|clear|popd|rm(| -*) (|*(\\|\/))\*)"
